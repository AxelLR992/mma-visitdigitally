...
<!--<![endif]-->
<head>
    <title>PlanetM.us | Hello!</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="PlanetM develops and executes comprehensive marketing strategies and solutions for the world’s most innovative global and personal brands creating unique communities across platforms in any language.  ">
    <meta charset="UTF-8">
...
<h2>
                    <br /><br /><br />
                    WE CONNECT GLOBAL AND PERSONAL <br />BRANDS WITH PEOPLE
    ...
    <div id="partners" class="section-cotent">
        <div class="container">
            ...
            <div class="row" style="text-align:center">
                ...
                <center>
                <div class="col-md-3 col-sm-6 col-xs-12" >
                       <img src="images/525.png" class="img-responsive center-block" />
                    </div>
            ...
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <p>
                        ...
                        Copyright &copy; 2018 PlanetM!&nbsp;&nbsp;|&nbsp;&nbsp;<a data-toggle="modal" data-target="#modal_login">Privacy Policy</a><br />
                        <br />
                        ...
                        &nbsp;&nbsp;&nbsp;<a href="https://www.pinterest.com/planetmworld/" target="_blank"><i class="fa fa-pinterest-square fa-3x"></i></a>&nbsp;&nbsp;&nbsp;<a href="https://www.youtube.com/channel/UCUzG6-2NziWBdSdcrIn0k6A" target="_blank"><i class="fa fa-youtube-square fa-3x"></i></a>&nbsp;&nbsp;&nbsp;<a href="https://plus.google.com/+CarlosVassallo" target="_blank"><i class="fa fa-google-plus-square fa-3x"></i></a>
                    </p>
                </div>
                <!-- /.col-md-6 -->
                <div class="col-md-4 col-sm-4 col-xs-12">
