...
<head>
    ...
    <meta name="description" content="PlanetM - es una empresa de servicios digitales y de marketing de tecnología con oficinas en la ciudad de Nueva York y América Latina. Conectamos marcas globales y personales con personas. Desarrollamos soluciones que pueden tener un impacto en la forma en que nuestros clientes hacen negocios. Desde AI hasta IoT, desde Analytics, hasta Blockchain y aplicaciones basadas en la nube, ayudamos a nuestros clientes en formas que van mucho más allá de las herramientas de marketing convencionales.">
    <meta property="og:title" content="PlanetM.us" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:url" content="https://www.planetm.us" />
    <meta property="og:image" content="https://www.planetm.us/images/slide1bg_1.jpg" />
    ...
    <!-- Favicons -->
    <link rel="icon" type="image/png" href="https://www.planetm.us/favicon.png" />
    ...
    <div class="fullscreen-bg">
        <div class="row">
            <div class="col-md-10 col-md-offset-1 col-sm-12 col-xs-12 video_blurb">
              <h3>
							<span id="swpText">Contenidos</span></h3> 
<h2>
                    <br /><br /><br />
                    Conectamos Marcas Globales<br />y Personales Con Gente
...
var accText = ["Digital Media Rooms","Marketing Experimental","Contenidos","Patrocinios"];
var index=0;
...
setInterval(changeText, 2000);
        ...
        <video loop muted autoplay width="100%" height="auto" class="tall">
            <source src="../video/espanolajustado.mp4" type="video/mp4">
        </video>
    </div>
    <!-- /#home -->
    ...
    <div id="about" class="section-cotent">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9">
                    <h4 class="widget-title">Ayudamos a conectar marcas Globales y personales con consumidores</h4>
                    <p class="area_text">
                        PlanetM concibe, crea y ejecuta plataformas de mercadeo y soluciones para las marcas mundiales más innovadoras incluyendo marcas personales.
                        <br />
                        <br />
                        Nuestro equipo multicultural tiene más de 100 años de experiencia combinados usando diferentes tecnologías para desarrollar programas que se traducen en una experiencia de usuario única, excepcional e inteligente produciendo ganancias significativas sobre el capital invertido.
                    </p>
                </div>
                <!-- /.col-md-3 -->
            ...
            <div class="row">
                <div class="col-md-7 col-sm-6">
                    ...
                    <div class="contact-form">
                        ...
                        <div class="g-recaptcha" data-sitekey="6Lf35HQUAAAAAJmXtpe4CET3kQxrQ3TAwtbFZipG"></div>
                        <div id="mail-status"></div>            
                                    <button class="mainBtn" type="Submit" id="send-message" style="clear:both;">Enviar Mensaje</button>
            ...
            <div class="row">
                <div class="col-md-8 col-sm-8 col-xs-12">
                    <p>
                        ...
                        Derechos Reservados &copy; 2019 PlanetM!&nbsp;&nbsp;|&nbsp;&nbsp;<a data-toggle="modal" data-target="#modal_login">Política de Privacidad</a><br />
                        <br />
