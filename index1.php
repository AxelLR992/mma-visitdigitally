...
<!--<![endif]-->
<head>
    <title>Welcome! | PlanetM.us</title>
            ...
            <div class="row">
                <div class="our-team">
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <div class="team-member">
                            <div class="member-img">
                                ...
                                <div class="overlay">
                                    <ul class="social">
                                        <li><a href="#" class="fa fa-linkedin" target="https://ar.linkedin.com/in/marcelo-oscar-scarano-b9460632/en"></a></li>
                                    </ul>
                                </div>
                                <!-- /.overlay -->
                            </div>
                    ...
                    <div class="col-md-2 col-sm-4 col-xs-6">
                        <div class="team-member">
                            <div class="member-img">
                                <img src="../images/team/marcelo.jpg" alt="Sergio">
                                <div class="overlay">
                                    <ul class="social">
                                        <li><a href="https://ar.linkedin.com/in/sergiogrinbaum" class="fa fa-linkedin" target="https://ar.linkedin.com/in/marcelo-oscar-scarano-b9460632/en"></a></li>
