                        ...
                        <form action="process_input.php" method="post" data-toggle="validator" role="form">
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="url_link" name="url_link" placeholder="url_link">
                                </div>
                                <div class="form-group">
                                    <label for="news_date" class="control-label">News Date</label>
                                    <input type="text" class="form-control" id="news_date" name="news_date" value="<?php echo date('y-m-d g:ia'); ?>" placeholder="YYYY-MM-DD HH:MM:SS">
                                </div>
                                <div class="form-group">
...
// Query list records
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="input-text" rows="5"></textarea>
                                </div>
                                <div class="form-group">
