        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    $stmt = $mysqli->prepare("SELECT recordid,url_link,news_date,title,subtitle,cat_id,img_sm,img_bg,description,status,display_priority,last_modified FROM news WHERE recordid=?") or die(mysqli_error($mysqli));
                    $stmt->bind_param('i', $_GET['rid']);
                    $stmt->execute();    // Execute the prepared query.
                    $stmt->store_result();
                    // get variables from result.
                    $stmt->bind_result($db_recordid, $db_url_link, $db_news_date, $db_title, $db_subtitle, $db_cat_id, $db_img_sm, $db_img_bg, $db_description, $db_status, $db_display_priority, $db_last_modified);
                    $stmt->fetch();
                    ?>
                    <div class="row">
                        <form action="process_edit.php" method="post" data-toggle="validator" role="form">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">                                
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="url_link" name="url_link" value="<?php echo $db_url_link ?>">
                                </div>
                                <div class="form-group">
                                    <label for="news_date" class="control-label">News Date</label>
                                    <input type="text" class="form-control" id="news_date" name="news_date" value="<?php echo $db_news_date ?>">
                                </div>
                                <div class="form-group">
...
// Query list records
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="input-text" rows="5"><?php echo $db_description ?>
                                    </textarea>
                                </div>
                                 <div class="form-group">
