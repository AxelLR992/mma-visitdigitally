...
<body>
    ...
    <div class="fullscreen-bg">
        ...
        <img src="../img/bck_nyu_4.jpg" width="100%" height="auto" class="tall"/></a>   
    ...
    <section id="how-it-works" class="event-type-section" style="padding-top: 130px;">
        <div class="container">
            ...
            <div class="row justify-content-center no-gutters">
                ...
                <span style="color: #55cbfc; font-weight: bold">READY IN MINUTES</span></br>
            ...
            <div class="row justify-content-center no-gutters stagger-tween">
                ...
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            ...
                            <br><span style="color: #55cbfc; font-weight: bold">LIVE INTERACTION</span></br>Talk live to an administrator, alumni, current students, professors and others! Engage your audience and secure a sale!
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">STUDENTS</span></br>
                            Get them involved in your live presentation. Most prospective domestic and international students want to interact and engage with current students. 
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">LIVE CLASSES</span></br>
                            Watch a live class of your university of choice upon request and when available.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">E-COMMERCE</span></br>
                            Promote and sell your products and let your audience shop their favorite items and products including text books from the University website.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">CONTENT</span></br>
                            Produce specific  content, including videos, photos, text, chats and social media posting adding also user generated content.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">DATA INTELLIGENCE</span></br>
                            Gather data  in real time from your visitors and generate your own insights to better target your audience.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">CLOUD SERVICES</span></br>
                            Our platform is fully responsive in any device and can be added to any page of your website without interfering with its content. No downloads are needed.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">MULTILANGUAGE</span></br>
                            Build as many as Digital Media Rooms as needed in the language of your choice.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">OMMICHANNEL</span></br>
                            Optimize your cross-channel content strategy to improve user experience and drive better relationships with your audience across point of contact.  Our Digital Media Rooms are designed and orchestrated to cooperate.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">REAL TIME FEEDBACK</span></br>
                            Invite prospective students at any stage of the recruitment cycle: from enquirer to admitted student to pre-enrollment.Have polls, surveys and live questionnaires on demand.
                ...
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">Ai, VIRTUAL & AUGMENTED REALITY</span></br>
                            Special Service: Our machine learning algorithm analyses conversations to measure engagement and understand what your prospects are talking about. Broadcast in virtual reality anytime.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">CHATS & SOCIAL MEDIA</span></br>
                            Broadcast live to social media including Youtube, facebook, Instagram, linkedin and others.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center no-gutters stagger-tween">
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">VIRTUAL TOURS</span></br>
                            Increase your success rate. Show all offerings from academic presentations to admission and financial aid, and life inside and outside the classroom. Help your audience to explore campus life, meet students & discover your hands on approach to education.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">LIVE EVENTS</span></br>
                            Online learning, Virtual classrooms, Town halls, business plan competitions, and other live events including user generated content.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">APP & SOFT INTEGRATION</span></br>
                            Integrated most app and existing software into our Digital Media rooms.  <a href="https://www.visitdigitally.com/apps.pdf">Click here</a> to see a list of the most used products. .
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">EXCLUSIVE CONTENT</span></br>
                            Video essays, application process, virtual colleges fairs, student orientation, send you are accepted notes via our Digital Media Rooms and make them to accept your offer. Includes surveys and metadata at an individual level.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center no-gutters stagger-tween">
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">LETSCAST</span></br>
                            Create your own live channel to broadcast 24/7 and or on demand.  Distribute live content to Social Media networks in a click. Supports captioning for translation and accessibility
.
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <h5 class="text-white text-uppercase text-shadow p-3 px-lg-4" style="position : absolute; bottom : 0px;">Courses---></h5>
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">COURSES</span></br>
                            Teach any course live using a white board including library materials, study guides and class overviews.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <h5 class="text-white text-uppercase text-shadow p-3 px-lg-4" style="position : absolute; bottom : 0px;">Sports---></h5>
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">SPORTS</span></br>
                            Broadcast live sports and archives In your own vertical in a flash!.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 p-2 stagger-tween-item">
                    <div class="reveal-container">
                        ...
                        <h5 class="text-white text-uppercase text-shadow p-3 px-lg-4" style="position : absolute; bottom : 0px;">Fireside Chats---></h5>
                        <div class="px-3 py-2 p-md-3 px-lg-4 py-lg-4 d-flex flex-row align-items-center reveal-subcontainer">
                            <div class="reveal-content">
                            <br><span style="color: #55cbfc; font-weight: bold">FIRESIDE CHATS</span></br>
                            Distribute your content in any language by promoting your fireside chats to the world.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-7 col-sm-6">
                        ...
                        <div class="contact-form">
                            <form id="contact_form" enctype="multipart/form-data" method="post">
                                ...
                                <button class="btn btn-primary" type="Submit" id="send-message" style="clear:both;">SEND MESSAGE</button>
