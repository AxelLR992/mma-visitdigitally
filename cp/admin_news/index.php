...
// Count table records
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div><b><?php echo $rc ?></b> News records</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <table id="list_news" class="display" width="98%">
                                <thead>
                                    <tr>
                                        <th>recordid</th>
                                        <th>title</th>
...
// Query list records
                                    ...
                                    $sql = "SELECT recordid, title, subtitle, cat_id, news_date, display_priority FROM news order by news_date desc";
                                    $result = $mysqli->query($sql);
                                    $i = 0;
