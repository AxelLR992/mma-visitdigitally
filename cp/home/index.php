...
<head>
    ...
    <title>VisitDigitally Control Panel</title>
    ...
    <link rel="icon" type="image/png" href="http://www.visitdigitally.com/favicon.png" />
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            VisitDigitally.com <small>Control Panel by VisitDigitally</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
