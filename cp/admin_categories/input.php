                    ...
                    <div class="row">
                        <form action="process_input.php" method="post" data-toggle="validator" role="form">
                            <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12" style="padding-left: 10px; padding-right: 10px; padding-bottom: 10px;">
                                ...
                                <div class="form-group">
                                    <label for="cat_level" class="control-label">Level</label>
                                ...
                                <div class="form-group">
                                    <label for="parent_cat_id" class="control-label">Parent Cat</label>
...
// Query list records
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="input-text" rows="3"></textarea>
                                </div>
                                <div class="form-group">
